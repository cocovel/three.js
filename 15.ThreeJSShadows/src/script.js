...
const directionalLightCmaeraHelper = new THREE.CameraHelper(directionalLight.shadow.camera)
directionalLightCmaeraHelper.visible = false
scene.add(directionalLightCmaeraHelper)
